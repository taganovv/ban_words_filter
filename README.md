...
Зритель напишет `p1d0r`, `п​идор` с невидимым символом или `пиииидор` — фильтр нормализует текст и всё равно поймает совпадение. У типичных списков запрещённых слов в облачных ботах такой глубины обработки нет.
